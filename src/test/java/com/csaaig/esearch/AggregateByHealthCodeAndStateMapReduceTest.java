...
import com.sample.healthcost.AggregateByHealthCodeAndStateMapper;
import com.sample.healthcost.AggregateByHealthCodeAndStateReducer;

public class AggregateByHealthCodeAndStateMapReduceTest {
	...
	**/
	...
	public void setUp() {
		...
		mapDriver.setMapper(new AggregateByHealthCodeAndStateMapper());
		reduceDriver = ReduceDriver.newReduceDriver();
		reduceDriver.setReducer(new AggregateByHealthCodeAndStateReducer());		
	}
	...
	public void testMapper() {
		...
		mapDriver.withOutput(new Text("99222~MD"), new Text("1003000126	ENKESHAFI	ARDALAN		M.D.	M	I	900 SETON DR		CUMBERLAND	215021854	MD	US	Internal Medicine	Y	F	99222	Initial hospital care	115	112	115	135.25	0	199	0	108.11565217	0.9005883395"));
		mapDriver.runTest();
	}
	...
	public void testReducer() {
		...
		reduceDriver.withInput(new Text("99222~MD"), values);
		reduceDriver.withOutput(new Text("99222~MD"), new Text("99222~MD,99222,Initial hospital care,MD,133.492826085,108.11565217,158.87"));
